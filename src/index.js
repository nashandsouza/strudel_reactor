...
// ✅ Use Bootstrap but don’t edit any CSS files
import 'bootstrap/dist/css/bootstrap.min.css';

// ✅ Inject dark theme styles at runtime (since you can’t touch App.css)
const DARK_CSS = `
:root {
  --bg: #0b0f17; --card:#121a2b; --ink:#e8eef9; --ink-dim:#9cb0d2;
  --line:#20304b; --accent:#66a3ff; --success:#38d18e; --danger:#ff6b6b;
}
